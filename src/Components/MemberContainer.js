        ...
        <Container className='personDetails'>
          ...
          <Row>
            ...
            <h1>Matt Layden</h1>
              ...
              <p className="whatIDid">Matt is an ambitious and eager Full stack programmer who is working to become an expert and professional. He is a valuable member of a team comprised of cooperative and vocal people. During this project he has been an important contributor in completing the majority of the teams goals. He seeks to continue to do so in his future of programming.  </p>
            </Col>
          </Row>
